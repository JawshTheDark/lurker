...
- **Image uploads.** Paste, drag, or pick an image; Lurker optimizes it, uploads it to [x0.at](https://x0.at), [catbox.moe](https://catbox.moe), or your own self-hosted host ([Hoarder](https://github.com/amiantos/hoarder), [Zipline](https://github.com/diced/zipline), [Chibisafe](https://github.com/chibisafe/chibisafe)), inserts the link into your message, and keeps a history of all your uploads.
