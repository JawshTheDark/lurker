...
function onKeydown(e: KeyboardEvent): void {
  ...
  // user's aliases); otherwise fall back to channel / nick completion. Strip the
  // sigil off both forms — '#' stays in a channel result but neither '#'/'@'
  // belongs in the *prefix* we match on (asking for nicks starting with '@'
  // matches nothing).
