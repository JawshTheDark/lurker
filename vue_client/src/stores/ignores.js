...
export const useIgnoresStore = defineStore('ignores', {
  ...
  getters: {
    masksFor: (state) => (networkId) => state.byNetwork[networkId] || [],
    ...
    isIgnored: (state) => (networkId, nick, userhost) => {
